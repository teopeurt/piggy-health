...
/**
 * REST controller for managing {@link com.pigstycoders.domain.BloodPressure}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BloodPressureResource {
    ...
    public ResponseEntity<List<BloodPressure>> getAllBloodPressures(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
