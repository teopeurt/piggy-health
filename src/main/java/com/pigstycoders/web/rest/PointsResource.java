...
import com.pigstycoders.repository.PointsRepository;
import com.pigstycoders.repository.search.PointsSearchRepository;
...
/**
 * REST controller for managing {@link com.pigstycoders.domain.Points}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PointsResource {
     ...
     */
    @GetMapping("/points")
    public ResponseEntity<List<Points>> getAllPoints(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
