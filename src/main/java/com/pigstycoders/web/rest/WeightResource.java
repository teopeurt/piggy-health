...
/**
 * REST controller for managing {@link com.pigstycoders.domain.Weight}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WeightResource {
     ...
     */
    @GetMapping("/weights")
    public ResponseEntity<List<Weight>> getAllWeights(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
