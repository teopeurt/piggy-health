...
export const Points = (props: RouteComponentProps<{ url: string }>) => {
  ...
  return (
    <div>
      <h2 id="points-heading" data-cy="PointsHeading">
        <Translate contentKey="piggyHealthApp.points.home.title">Points</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="piggyHealthApp.points.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="piggyHealthApp.points.home.createLabel">Create new Points</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('piggyHealthApp.points.home.search')}
                />
        ...
        {pointsList && pointsList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="piggyHealthApp.points.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="piggyHealthApp.points.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('exercise')}>
                  <Translate contentKey="piggyHealthApp.points.exercise">Exercise</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('meals')}>
                  <Translate contentKey="piggyHealthApp.points.meals">Meals</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('alcohol')}>
                  <Translate contentKey="piggyHealthApp.points.alcohol">Alcohol</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('notes')}>
                  <Translate contentKey="piggyHealthApp.points.notes">Notes</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="piggyHealthApp.points.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="piggyHealthApp.points.home.notFound">No Points found</Translate>
            </div>
          )
        )}
      </div>
