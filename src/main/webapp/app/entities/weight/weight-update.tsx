  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="piggyHealthApp.weight.home.createOrEditLabel" data-cy="WeightCreateUpdateHeading">
            <Translate contentKey="piggyHealthApp.weight.home.createOrEditLabel">Create or edit a Weight</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('piggyHealthApp.weight.timestamp')}
                id="weight-timestamp"
                name="timestamp"
                data-cy="timestamp"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('piggyHealthApp.weight.weight')}
                id="weight-weight"
                name="weight"
                data-cy="weight"
                type="text"
              ...
              />
              <ValidatedField id="weight-user" name="user" data-cy="user" label={translate('piggyHealthApp.weight.user')} type="select">
                <option value="" key="0" />
                {users
