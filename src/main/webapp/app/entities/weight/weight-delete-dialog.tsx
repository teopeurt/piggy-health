...
export const WeightDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="piggyHealthApp.weight.delete.question">
        <Translate contentKey="piggyHealthApp.weight.delete.question" interpolate={{ id: weightEntity.id }}>
