...
export const Preferences = (props: RouteComponentProps<{ url: string }>) => {
  ...
  return (
    <div>
      <h2 id="preferences-heading" data-cy="PreferencesHeading">
        <Translate contentKey="piggyHealthApp.preferences.home.title">Preferences</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="piggyHealthApp.preferences.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="piggyHealthApp.preferences.home.createLabel">Create new Preferences</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('piggyHealthApp.preferences.home.search')}
                />
        ...
        {preferencesList && preferencesList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="piggyHealthApp.preferences.id">ID</Translate>
                </th>
                <th>
            ...
            <tbody>
              {preferencesList.map((preferences, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`piggyHealthApp.Units.${preferences.weightUnits}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="piggyHealthApp.preferences.home.notFound">No Preferences found</Translate>
            </div>
          )
        )}
      </div>
