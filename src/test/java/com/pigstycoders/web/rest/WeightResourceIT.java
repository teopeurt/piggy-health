...
import static com.pigstycoders.web.rest.TestUtil.sameInstant;
...
import com.pigstycoders.repository.WeightRepository;
import com.pigstycoders.repository.search.WeightSearchRepository;
...
class WeightResourceIT {
     ...
     *
     * @see com.pigstycoders.repository.search.WeightSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchWeight() throws Exception {
        ...
        // Initialize the database
        weightRepository.saveAndFlush(weight);
        when(mockWeightSearchRepository.search("id:" + weight.getId(), PageRequest.of(0, 20)))
